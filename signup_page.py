...
class SignUp:
    def __init__(self, root):
        ...
        self.window.config(bg = "#2E151B")

        #self.bg_img = ImageTk.PhotoImage(file="Online_project\photo1.jpeg")
        #background = Label(self.window,image=self.bg_img).place(x=0,y=0,relwidth=1,relheight=1)


        frame = Frame(self.window, bg="#DA7B93")
        frame.place(x=350,y=100,width=500,height=550)

        title1 = Label(frame, text="Sign Up", font=("times new roman",25,"bold"),bg="#DA7B93").place(x=20, y=10)
        title2 = Label(frame, text="Join with us", font=("times new roman",13),bg="#DA7B93", fg="black").place(x=20, y=50)

        f_name = Label(frame, text="First name", font=("times new roman",15,"bold"),bg="#DA7B93").place(x=20, y=100)
        l_name = Label(frame, text="Last name", font=("times new roman",15,"bold"),bg="#DA7B93").place(x=240, y=100)
        ...
        email = Label(frame, text="Email", font=("helvetica",15,"bold"),bg="#DA7B93").place(x=20, y=180)

        self.email_txt = Entry(frame,font=("arial"))
        self.email_txt.place(x=20, y=210, width=420)

        sec_question = Label(frame, text="Security questions", font=("helvetica",15,"bold"),bg="#DA7B93").place(x=20, y=260)
        answer = Label(frame, text="Answer", font=("helvetica",15,"bold"),bg="#DA7B93").place(x=240, y=260)
        ...
        password =  Label(frame, text="New password", font=("helvetica",15,"bold"),bg="#DA7B93").place(x=20, y=340)
