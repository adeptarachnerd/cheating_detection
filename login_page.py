...
class login_page:
    def __init__(self, root):
        self.window = root
        self.window.title("Login To Nayan")
        # Set the window size
        ...
        self.frame1 = Frame(self.window, bg="#DA7B93")
        self.frame1.place(x=0, y=0, width=450, relheight = 1)

        label1 = Label(self.frame1, text= "Nayan", font=("times new roman", 60, "bold"), bg="#DA7B93", fg="#2E151B").place(x=100,y=250)
        label2 = Label(self.frame1, text= "I.SEE.YOU", font=("times new roman", 30, "bold"), bg="#DA7B93", fg="#2E151B").place(x=115,y=350)
        #label3 = Label(self.frame1, text= "Nayan has the ability to continuously monitor the candidates during an \t online examination to confirm a cheat-free examination and make sure that the integrity and sanctity of exams can not be questioned.", font=("times new roman", 13, "bold"), bg="#DA7B93", fg="white").place(x=50,y=360,width=250)

        #=============Entry Field & Buttons============

        self.frame2 = Frame(self.window, bg = "#2E151B")
        self.frame2.place(x=450,y=0,relwidth=1, relheight=1)

        self.frame3 = Frame(self.frame2, bg="#DA7B93")
        self.frame3.place(x=140,y=150,width=500,height=450)

        self.email_label = Label(self.frame3,text="Email Address", font=("times new roman",20,"bold"),bg="#DA7B93", fg="#2E151B").place(x=50,y=40)
        ...
        self.password_label = Label(self.frame3,text="Password", font=("times new roman",20,"bold"),bg="#DA7B93", fg="#2E151B").place(x=50,y=120)
        ...
        #================Buttons===================
        self.login_button = Button(self.frame3,text="Log In",command=self.login_func,font=("times new roman",15, "bold"),bd=0,cursor="hand2",bg="#2E151B",fg="white").place(x=170,y=200,width=150)

        self.forgotten_pass = Button(self.frame3,text="Forgotten password?",command=self.forgot_func,font=("times new roman",15, "bold"),bd=0,cursor="hand2",bg="#2E151B",fg="white").place(x=125,y=260,width=250)

        self.create_button = Button(self.frame3,text="Create New Account",command=self.redirect_window,font=("times new roman",15, "bold"),bd=0,cursor="hand2",bg="#2E151B",fg="white").place(x=125,y=320,width=250)
        ...
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Welcome to the Nayan Family",parent=self.window)
